  ...
  return (
    <Grid templateColumns="repeat(2, 0.5fr)" gap={6}>
      <Flex direction="column" p={5} w="100%" h="10" colSpan={2}>
        ...
        <Textarea placeholder="Identify" mb={5}></Textarea>
        <Textarea placeholder="Outline" mb={5}></Textarea>
        <Textarea placeholder="Explain 1" mb={5}></Textarea>
        <Textarea placeholder="Explain 2" mb={5}></Textarea>
      ...
      <Container padding="5" maxW="2xl" bg="white.600" centerContent>
        ...
        <Box color="black">
          ...
          page when looking at its layout. The point of using Lorem will uncover
